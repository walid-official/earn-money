    ...
    <div className="w-[80%] mx-auto pb-14">
      <div className="pb-20">
        ...
        <p className="text-center text-white md:w-[60%] mx-auto py-3">
          With over 2 million active users, we’re turning earning opportunities
      ...
      <div className="bg-[#10121d] rounded-xl px-14 py-10 w-full  z-10 text-white shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="">
            ...
            <p className="text-left py-4">
              Our platform ensures the security of your personal information and
              earnings.
            </p>
            <div className="">
              {/* <progress className="progress w-56" value="70" max="100"></progress> */}
          ...
          <div className="">
            ...
            <p className="text-left py-4">
              Witnessing continuous growth with new opportunities for all users.
            </p>
            <div className="">
              {/* <progress className="progress w-56" value="70" max="100"></progress> */}
              <input
