          ...
          <div className="w-[50%] flex justify-center items-center">
            <div>
              ...
              <div className="flex justify-start py-3 gap-3 items-center">
                <NavLink to="/login">
                  <button className="bg-[#00d7c0] rounded-tr-2xl rounded-bl-2xl font-bold text-white hover:bg-[#00d7c0] py-3 px-7">Go To Login</button>
                </NavLink>
                <NavLink to="/">
          ...
          <div className="card w-[50%] bg-base-100 max-w-md shrink-0 shadow-2xl">
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                ...
                <input
                  ...
                  {...register("password", {
                    ...
                    pattern: {
                      ...
                      message: "Password must be at least 6 characters, include one uppercase letter, one lowercase letter, and one number",
                    },
                  })}
              ...
              <div className="form-control mt-6">
                <button type="submit" className="btn bg-[#00d7c0] hover:bg-[#00d7c0] border-none text-white font-medium">Register Now</button>
              </div>
              <div>
                <button
